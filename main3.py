...
start_datetime = pd.to_datetime("2025-02-18 00:00")
end_datetime = pd.to_datetime("2025-02-19 00:00")
...
output_filename = f"{start_datetime.strftime('%Y-%m-%d_%H-%M')}_animation1.mp4"
...
from functions.make_midi_3 import produce_midi_file
